...
| 3 | Script + Storyboard | 🟡 In progress — style_profile v0 (3.1), real Script Agent (3.2-3.4), and orchestrator wiring + apps/web "Run" button (3.4.5) done, see `docs/roadmap.md` |
