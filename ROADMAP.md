...
| 2 | Research + Knowledge + Trend Agents | 🟡 In progress — Research Agent v1/v2 (GitHub + YouTube), real Idea Scoring gate, Trend Agent v1 (GitHub Trending) done, see `docs/roadmap.md` 2.4/2.5/2.6/2.7/2.10 |
