...
| 3 | Script + Storyboard | 🟡 In progress — style_profile v0 (3.1), real Script Agent (3.2-3.4), orchestrator wiring + apps/web "Run" button (3.4.5), Prompt Library CRUD + versioning (3.5), Approval Gate #1 (3.6), the Storyboard module (3.7), the real Storyboard view + a design system for apps/web (3.8), and Research Agent manual-text sources for Instagram Reels/posts/tweets (3.8.5) done, see `docs/roadmap.md` |
